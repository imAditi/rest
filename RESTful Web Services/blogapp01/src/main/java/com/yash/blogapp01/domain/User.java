package com.yash.blogapp01.domain;
...
public class User {
	...
	public User(int id, String firstName, String lastName, long contact, String email, String password, int status, int role,
			String created_at, String updated_at, String skills) {
		super();
		this.id = id;
